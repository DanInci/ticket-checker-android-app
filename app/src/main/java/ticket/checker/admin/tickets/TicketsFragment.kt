...
//        get() = 20
//
//    override fun setupItemsAdapter(): AItemsAdapter<TicketList, Int> {
//       return TicketsAdapter(context!!)
//    }
//
//    override fun loadHeader(filterType : String?, filterValue : String) {
//        val call = ServiceManager.getStatisticsService().getTicketsNumbers(organizationId, categoryFilter, searchFilter)
//        call.enqueue(headerCallback)
//    }
//
//    override fun loadItems(page: Int, filterType: String?, filterValue : String?) {
//        val call = ServiceManager.getTicketService().getTicketsForOrganization(organizationId, page, loadLimit, categoryFilter, searchFilter)

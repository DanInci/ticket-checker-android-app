...
// */
//class TicketsAdapter(val context: Context) : AItemsAdapter<TicketList, Int>(context) {
//
...
//        }
//
//        private fun setValidated(date: OffsetDateTime?) {
//            if (date != null) {
...
//        }
//
//        private fun setSoldAt(soldAt: OffsetDateTime?) {
//            if (soldAt == null) {

...
//        tvSoldToBirthDate.text = if(ticket.soldToBirthdate != null) DATE_FORMAT_MONTH_NAME.format(ticket.soldToBirthdate) else "-"
//        tvSoldToTelephone.text = if(ticket.telephone != null) ticket.telephone else "-"
//        tvSoldAt.text = if (ticket.soldAt != null) DATE_TIME_FORMAT.format(ticket.soldAt) else "-"

...
//import ticket.checker.beans.OrganizationMembership
...
// */
//class UsersAdapter(val context : Context) : AItemsAdapter<OrganizationMembership, Int>(context) {
//
...
//    }
//
//    override fun updateItemInfo(holder: RecyclerView.ViewHolder, item: OrganizationMembership) {
...
//    }
//
//    override fun itemAdded(addedItem: OrganizationMembership) {
...
//    }
//
//    override fun itemEdited(editedItem: OrganizationMembership, position: Int) {
//        if(isItemPosition(position)) {
...
//
//        fun updateUserHolderInfo(user : OrganizationMembership) {
//            setName(user.name)
//            setUserType(user.role)
//            setCreatedAt(user.joinedAt)
//        }
//
...
//        }
//
//        private fun setCreatedAt(date : OffsetDateTime?) {
//            if(date != null) {
//                createdAtRow.visibility = View.VISIBLE
//                tvCreatedAt.text = DATE_FORMAT_MONTH_NAME.format(date)
//            }
//            else {
...
//            else -> items[position-1].id.timestamp()
//        }
//    }
//

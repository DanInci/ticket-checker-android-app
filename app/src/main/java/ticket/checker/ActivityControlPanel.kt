...
//
//        if(AppTicketChecker.selectedOrganization!!.pretendedRole == OrganizationRole.ADMIN) {
...
//                if(AppTicketChecker.selectedOrganization!!.pretendedRole != OrganizationRole.ADMIN && AppTicketChecker.selectedOrganization!!.pretendedRole != OrganizationRole.PUBLISHER) {
...
//                            }
//                            R.id.navigation_users -> {
//                                usersFragment?.onEdit(editedObject as UserProfile, position)
//                            }
//                        }
//                    }
//                }
